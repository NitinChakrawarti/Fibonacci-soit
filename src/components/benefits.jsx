...
const Benefits = () => {
    ...
    return (
        <div className='text-text_light mt-16 md:mt-28 flex justify-between'>
            <div className='px-8 lg:px-36 text-3xl bg-bg_Primary opacity-75 text-white pt-[2vmax] md:flex-row  flex-col w-[100%] gap-6'>
                ...
                <Fade duration="2000" > 
                <div className="pt-4 md:pt-16 flex overflow-hidden relative">
